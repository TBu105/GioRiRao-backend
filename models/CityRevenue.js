...
const DOCUMENT_NAME = "CityRevenue";
const COLLECTION_NAME = "CityRevenues";

// Create the Headquarter schema
const CityRevenueSchema = new mongoose.Schema(
  {
    cityId: {
...
CityRevenueSchema.index({ cityId: 1, date: 1 });

// Export the Country model
module.exports = mongoose.model(DOCUMENT_NAME, CityRevenueSchema);
