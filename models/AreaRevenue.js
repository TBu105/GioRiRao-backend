...
const DOCUMENT_NAME = "AreaRevenue";
const COLLECTION_NAME = "AreaRevenues";
...
AreaRevenueSchema.index({ areaId: 1, date: 1 });
AreaRevenueSchema.index({ cityId: 1, date: 1 });

// Export the Country model
module.exports = mongoose.model(DOCUMENT_NAME, AreaRevenueSchema);
